...
def main():
    ...
    # Cambiato il percorso base per usare results_None_SGD_lr0.01_5_3
    base_dir = os.path.join('results','results_None_SGD_lr0.01_5_3','KaNet5')
    ...
    for ckpt in ckpts:
        ...
        # crea le cartelle per ogni epoca e scala
